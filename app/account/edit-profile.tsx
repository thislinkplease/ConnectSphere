...
export default function EditProfileScreen() {
   ...
   const handleSave = async () => {
      ...
      try {
         ...
         const freshUser = currentUser?.username ? await ApiService.getUserByUsername(currentUser.username) : null;
         ...
         if (error?.response?.status === 500) {
            ...
            Alert.alert("Error", "User not found. Please try logging in again.", [{ text: "OK", style: "cancel" }]);
         } else {
                              ...
                              <TouchableOpacity
                                 ...
                                 style={[
                                    ...
                                    gender === g && [
                                       ...
                                       { borderColor: colors.primary, backgroundColor: colors.highlight },
                                    ],
                                 ]}
                                 onPress={() => setGender(g)}
                              >
